...
public class EmailController {
    ...
    public String acceptRejectApplicant(@ModelAttribute EmailInfo email, Principal principal, Model model)
    {
        model.addAttribute("searchApp", new Search());
        model.addAttribute("searchCamp", new Search());
    ...
    public String contactDirector(@ModelAttribute String message,@ModelAttribute User director,@ModelAttribute User current, Model model)
    {
        model.addAttribute("searchApp", new Search());
        model.addAttribute("searchCamp", new Search());
    ...
    public String contactStudent(@ModelAttribute String message,@ModelAttribute User student,@ModelAttribute User current, Model model)
    {
        model.addAttribute("searchApp", new Search());
        model.addAttribute("searchCamp", new Search());
